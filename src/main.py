...
parser.add_argument(
    "--rounds", default=30, type=int, help="number of totat federated rounds to run"
)
parser.add_argument(
    "--timeout",
    default=None,
    type=utils.none_or_int,
    nargs="?",
    help="maximum seconds of round until timeout",
)
...
parser.add_argument(
    ...
    default=0.5,
    type=float,
    help="percentage of cpu resources (cores) to be used by each client",
)
parser.add_argument(
    "--gpu_percentage",
    default=0.08,
    type=float,
    help="percentage of gpu resources to be used by each client",
)
parser.add_argument(
    "--participation",
    default=1.0,
    type=float,
    help="participation percentage of clients in each round",
)
parser.add_argument(
    "--epochs",
    default=1,
    type=int,
    help="number of local client epochs to run per federated round",
)
parser.add_argument(
    "--batch_size", default=32, type=int, help="batch size for local client training"
)
parser.add_argument("--learning_rate", default=1e-1, type=float, help="learning rate")
parser.add_argument(
    "--dataset", default="cifar10", type=str, help="dataset name to use for trainig"
)
parser.add_argument(
    "--model_name", default="resnet20", type=str, help="dataset name to use for trainig"
)
parser.add_argument(
    "--init_model_fp",
    default=None,
    type=utils.none_or_str,
    nargs="?",
    help="initialization model path",
)
parser.add_argument(
    "--results_dir",
    default="../assets/results",
    type=str,
    help="store results directory",
)
parser.add_argument(
    "--model_dir",
    default="../assets/saved_models",
    type=str,
    help="store model directory",
)
parser.add_argument(
    "--seed", default=0, type=int, help="seed used to achieve reproducibility"
)
...
parser.add_argument(
    ...
    default=8,
    type=int,
    help="initial number of clusters for weight clustering",
)
parser.add_argument(
    "--max_num_clusters",
    default=20,
    type=int,
    help="maximum number of clusters for weight clustering",
)
parser.add_argument(
    "--cluster_update_step",
    default=1,
    type=int,
    help="search step for optimal number of clusters for weight clustering",
)
parser.add_argument(
    "--cluster_search_init_rounds",
    default=1,
    type=int,
    help="initial rounds before starting cluster search",
)
parser.add_argument(
    "--cluster_search_window",
    default=3,
    type=int,
    help="window of metric average for optimal number of clusters for weight clustering",
)
parser.add_argument(
    "--cluster_search_patience",
    default=3,
    type=int,
    help="patience step for optimal number of clusters for weight clustering",
)
parser.add_argument(
    "--cluster_search_metric_limit",
    default=1.0,
    type=float,
    help="metric minimum improvement limit for switch number of clusters",
)
parser.add_argument(
    "--client_compression",
    dest="client_compression",
    action="store_true",
    help="use client-side weight clustering",
)
parser.add_argument(
    "--client_compression_epochs",
    default=5,
    type=int,
    help="local train epochs with weight clustering",
)
parser.add_argument(
    "--client_compression_lr",
    default=1e-4,
    type=float,
    help="learning rate for local train epochs with weight clustering",
)
parser.add_argument(
    "--server_compression",
    dest="server_compression",
    action="store_true",
    help="use server-side ood weight clustering with KD",
)
parser.add_argument(
    "--server_compression_step",
    default=1,
    type=int,
    help="frequency step for applying server-side ood weight clustering with KD",
)
parser.add_argument(
    "--server_compression_epochs",
    default=5,
    type=int,
    help="train epochs with server-side ood weight clustering with KD",
)
parser.add_argument(
    "--server_compression_lr",
    default=1e-4,
    type=float,
    help="learning rate for server-side ood weight clustering with KD",
)
parser.add_argument(
    "--server_compression_batch",
    default=256,
    type=int,
    help="batch size for server-side ood weight clustering with KD",
)
parser.add_argument(
    "--server_compression_temperature",
    default=8.0,
    type=float,
...
def main(run_id=0):
    ...
    history = fl.simulation.start_simulation(
        ...
        config=fl.server.ServerConfig(
            num_rounds=args.rounds, round_timeout=args.timeout
        ),
    )
    return history
